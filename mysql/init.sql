...
INSERT INTO `personnages` (`id`, `nom_fr`, `nom_jp`, `role`, `faction`, `age`, `description`) VALUES
                                                                                                  ...
                                                                                                  (5,'Prof. Procyon','Genzo Umon','Scientifique','Terre',60,'Scientifique de génie, père de Vicky. C\'est lui qui a découvert Goldorak caché sur Terre et l\'a restauré. Conseiller scientifique et stratégique de l\'équipe, il développe les technologies et les stratégies pour contrer les attaques Vegan.'),
                                                                                                  ...
                                                                                                  (21,'Grand Stratégor','大司令 (Dai-Shirei)','Commandant suprême des forces Vegan','Véga',NULL,'Commandant en chef basé sur la Planète Fleur'),
                                                                                                  (22,'Princesse Aphrodia','アフロディア姫 (Afurodia-hime)','Princesse et commandante Vegan','Véga',25,'Princesse de Vega qui finit par trahir son peuple'),
                                                                                                  (23,'Floga','フロガ (Furoga)','Commandant des forces de Floga','Floga',NULL,'Nouvel ennemi apparu à la fin de la série'),
                                                                                                  (32,'Général Dargol','ダルゴル将軍 (Darugoru Shōgun)','Général des armées Vegan','Véga',40,'Général important des forces de Vega');
...
INSERT INTO `robots` (`id`, `nom_fr`, `nom_jp`, `pilote_id`, `description`, `type_robot`, `hauteur`, `poids`) VALUES
                                                                                                                  ...
                                                                                                                  (22,'Gandal','ガンダル (Gandaru)',8,'Premier robot géant vegan envoyé sur Terre, tête de cheval','Robot Géant',38.00,420.00),
...
INSERT INTO `vaisseaux` (`id`, `nom_fr`, `nom_jp`, `type_vaisseau`, `pilote_id`, `description`, `faction`) VALUES
                                                                                                               ...
                                                                                                               (18,'Soucoupe Végan Type A','ベガ円盤A型 (Vega Enban A-gata)','Chasseur Spatial',NULL,'Chasseur spatial de base des forces Vegan','Véga'),
                                                                                                               (19,'Soucoupe Végan Type B','ベガ円盤B型 (Vega Enban B-gata)','Bombardier',NULL,'Bombardier lourd des forces Vegan','Véga'),
                                                                                                               (20,'Vaisseau-Mère Végan','ベガ母艦 (Vega Bokan)','Cuirassé Spatial',21,'Cuirassé spatial de commandement des forces Vegan','Véga');
